...
function mostrarDocumento(){
					...
					if(""== tipo){
						...
						if ((null!= tipo) && ("" != tipo) && ("N" == tipo)){
							...
							//alert("CMRO urlDoc = "+urlDoc);
								...
								setTimeout(function(){ 
									//CMRO window.onerror = mostrarError;
		...
		{	
			//alert("CMRO en verificaDocumento");
					...
					if (tipodoc == "T"){
						...
						$j.ajax({
							  ...
							  success: function(data){
							  		...
							  		//CMRO
							  		alert("CMRO en el ajax, urlbol = "+urlbol);
							  		//CMRO
				...
				<td id="txt5" bgcolor="#c1c1c1">
						<html:select property="documento"
						 styleClass="fto" styleId="tipo">
							...
							<html:option value="O">Guía de Despacho Venta</html:option>
